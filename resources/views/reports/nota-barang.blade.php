                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);" class="active"><span>Sales</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li class="submenu">
                                        ...
                                        <li><a href="invoice.html" class="active"><span>Invoices</span></a></li>
                ...
                <div class="twocol-mini">
                    <div class="sidebar-left slimscroll">
                        <div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
                            ...
                            <a href="#" class="nav-link active" title="Sales" data-bs-toggle="tab"
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="page-header">
                    ...
                    <div class="page-btn">
                        <a href="invoice.html" class="btn btn-primary"><i data-feather="arrow-left"
                                class="me-2"></i>Back to Invoices</a>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-between align-items-center border-bottom mb-3">
                            <div class="col-md-6">
                                <div class="mb-2">
                                    <img src="{{ asset('assets') }}/img/logo.svg" width="130"
                        ...
                        <div class="row border-bottom mb-3">
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <div class="mt-3">
                                        <img src="{{ asset('assets') }}/img/qr.svg" class="img-fluid"
                                            alt="QR">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center border-bottom mb-3">
                            ...
                            <div class="col-md-5">
                                <div class="text-end">
                                    <img src="{{ asset('assets') }}/img/sign.svg" class="img-fluid"
                                        alt="sign">
                                </div>
                                <div class="text-end mb-3">
