	...
	if($('.tabelNampan').length > 0) {
        $('.tabelNampan').DataTable({
            ...
            columns: [
                ...
                { data: 'nampan' },       // Kolom ID
                { data: 'status' },     // Kolom Nama
                { 
                    ...
                    render: function (data, type, row, meta) {
                        return `
                            <div class="edit-delete-action">
                                <a class="me-2 edit-icon p-2" href="product-details.html?id=${row.id}">
                                    <i data-feather="eye" class="feather-eye"></i>
                                </a>
                                <a class="me-2 p-2" href="edit-product.html?id=${row.id}">
                                    <i data-feather="edit" class="feather-edit"></i>
                                </a>
                                <a class="confirm-text p-2" href="javascript:void(0);" onclick="deleteProduct(${row.id})">
                                    <i data-feather="trash-2" class="feather-trash-2"></i>
                                </a>
                            </div>
                        `;
